...
--
-- Host: localhost:3306
-- Generation Time: Nov 02, 2023 at 07:01 AM
...
--
-- Table structure for table `raw_sauce1`
--

CREATE TABLE `raw_sauce1` (
  `id` int(11) NOT NULL,
  `batch` text,
  `reccord_date` text,
  `tank_id` int(11) DEFAULT NULL,
  ...
  `nacl_t1` double DEFAULT NULL,
  `nacl_t2` double DEFAULT NULL,
  `nacl_t_avr` double DEFAULT NULL,
  `nacl_p1` double DEFAULT NULL,
  `nacl_p2` double DEFAULT NULL,
  `nacl_p_avr` double DEFAULT NULL,
  `tn_t1` double DEFAULT NULL,
  `th_t2` double DEFAULT NULL,
  `tn_t_avr` double DEFAULT NULL,
  `tn_p1` double DEFAULT NULL,
  `tn_p2` double DEFAULT NULL,
  `tn_p_avr` double DEFAULT NULL,
  `col` int(11) DEFAULT NULL,
  `alc_t` double DEFAULT NULL,
  `alc_p` double DEFAULT NULL,
  `ppm` text,
  `brix` text,
  `remask` text,
  `created_at` text,
...
--
-- Table structure for table `raw_sauce3`
--

CREATE TABLE `raw_sauce3` (
  `id` int(11) NOT NULL,
  `batch` varchar(255) DEFAULT NULL,
  `reccord_date` date DEFAULT NULL,
  `tank_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `raw_sauce3`
--

INSERT INTO `raw_sauce3` (`id`, `batch`, `reccord_date`, `tank_id`, `type_id`, `ph`, `nacl_t1`, `nacl_t2`, `nacl_t_avr`, `nacl_p1`, `nacl_p2`, `nacl_p_avr`, `tn_t1`, `th_t2`, `tn_t_avr`, `tn_p1`, `tn_p2`, `tn_p_avr`, `col`, `alc_t`, `alc_p`, `ppm`, `brix`, `remask`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES
(2, NULL, '2023-04-05', 6, 7, '4.81', '7.95', '7.95', '7.95', '16.09', '16.09', '16.09', '5.20', '5.20', '5.20', '1.99', '1.99', '1.99', 23, '11.30', '2.00', '832.00', '0.00', '', '0000-00-00', NULL, NULL, NULL),
(3, NULL, '2023-04-07', 6, 7, '4.72', '7.90', '8.00', '7.95', '15.99', '16.19', '16.09', '4.75', '4.90', '4.83', '2.06', '2.03', '2.05', 23, '14.50', '1.27', '706.00', '0.00', '', '0000-00-00', '0000-00-00', 0, 0),
(4, NULL, '2023-04-29', 8, 7, '4.55', '7.80', '7.75', '7.78', '15.79', '15.69', '15.74', '5.00', '5.15', '5.08', '2.01', '1.99', '2.00', 11, '14.75', '1.19', '911.00', '0.00', '', '0000-00-00', '0000-00-00', 0, 0),
(5, NULL, '2023-05-02', 8, 7, '4.59', '7.70', '7.75', '7.73', '15.58', '15.69', '15.64', '4.90', '4.90', '4.90', '2.01', '2.01', '2.01', 27, '15.25', '1.08', '759.00', '0.00', '', '0000-00-00', '0000-00-00', 0, 0),
(6, NULL, '2023-06-26', 6, 7, '4.58', '7.85', '7.85', '7.85', '15.94', '15.94', '15.94', '5.20', '5.05', '5.13', '1.97', '1.99', '1.98', 23, '15.25', '1.08', '1012.00', '37.60', '', '0000-00-00', '0000-00-00', 0, 0),
(7, NULL, '2566-06-27', 6, 7, '4.55', '7.70', '7.70', '7.70', '15.63', '15.63', '15.63', '4.50', '4.50', '4.50', '2.06', '2.06', '2.06', 23, '15.00', '1.14', '1089.00', '38.40', '', '0000-00-00', '0000-00-00', 0, 0),
(8, NULL, '2023-01-25', 10, 7, '4.48', '7.60', '7.70', '7.65', '15.43', '15.63', '15.53', '5.25', '5.25', '5.25', '1.98', '1.98', '1.98', 23, '17.65', '0.62', '1100.00', '0.00', '', '0000-00-00', '0000-00-00', 0, 0),
(9, NULL, '2023-03-03', 7, 7, '5.02', '8.45', '8.50', '8.48', '17.10', '17.20', '17.15', '6.30', '6.45', '6.38', '1.83', '1.81', '1.82', 31, '13.10', '1.58', '481.00', '0.00', '', '0000-00-00', '0000-00-00', 0, 0),
(10, NULL, '2023-05-16', 7, 7, '4.61', '7.70', '7.75', '7.73', '15.58', '15.69', '15.64', '5.60', '5.45', '5.53', '1.89', '1.91', '1.90', 29, '13.75', '1.43', '438.00', '0.00', '', '0000-00-00', '0000-00-00', 0, 0),
(11, NULL, '2023-07-08', 6, 7, '4.62', '6.45', '6.45', '6.45', '13.09', '13.09', '13.09', '5.15', '5.15', '5.15', '1.97', '1.97', '1.97', 27, '16.40', '0.86', '1100.00', '35.40', '', '0000-00-00', '0000-00-00', 0, 0),
(12, NULL, '2023-01-25', 10, 8, '4.48', '7.60', '7.70', '7.65', '15.43', '15.63', '15.53', '5.25', '5.25', '5.25', '1.98', '1.98', '1.98', 23, '17.65', '0.62', '1100.00', '0.00', NULL, '0000-00-00', NULL, NULL, NULL),
(13, NULL, '2023-03-03', 7, 8, '5.02', '8.45', '8.50', '8.48', '17.10', '17.20', '17.15', '6.30', '6.45', '6.38', '1.83', '1.81', '1.82', 31, '13.10', '1.58', '481.00', '0.00', NULL, '0000-00-00', NULL, NULL, NULL),
(14, NULL, '2023-05-16', 7, 8, '4.61', '7.70', '7.75', '7.73', '15.58', '15.69', '15.64', '5.60', '5.45', '5.53', '1.89', '1.91', '1.90', 29, '13.75', '1.43', '438.00', '0.00', NULL, '0000-00-00', NULL, NULL, NULL),
(15, NULL, '2023-07-08', 6, 8, '4.62', '6.45', '6.45', '6.45', '13.09', '13.09', '13.09', '5.15', '5.15', '5.15', '1.97', '1.97', '1.97', 27, '16.40', '0.86', '1100.00', '35.40', NULL, '0000-00-00', NULL, NULL, NULL),
(16, NULL, '2023-01-14', 12, 10, '4.49', '8.20', '8.25', '8.23', '16.65', '16.75', '16.70', '7.15', '7.20', '7.18', '1.71', '1.70', '1.71', 27, '15.70', '1.06', '707.00', '0.00', NULL, '0000-00-00', NULL, NULL, NULL);
...
--
-- Indexes for table `raw_sauce3`
--
ALTER TABLE `raw_sauce3`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `raw_sauce3`
--
ALTER TABLE `raw_sauce3`
