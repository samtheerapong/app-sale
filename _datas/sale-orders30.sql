...
--
-- Host: localhost:3306
-- Generation Time: Oct 30, 2023 at 04:12 PM
...
(17, 'FCKE-A2001', 'Organic Fairatrade Ketjap manis 200L Autour La Du Riz Brand', 'ล.', '', '', 1),
...
(69, 'FFOR-A2001', 'Fairtrade Tamari Organic Soy Sauce 200 L', 'ล.', '', '', 1),
(70, 'FFOR-A2002', 'Fairtrade organic Tamari No.1 soy sauce 200 L', 'ล.', '', '', 1),
(71, 'FFOR-A2003', 'Organic FairTrade Shoyu 200 L -Autour Du Riz L\'Asie Brand', 'ถัง', '', '', 1),
(72, 'FFOR-A2004', 'Organic Fairtrade Shoyu Less salt soy sauce 200L -Autour Du Riz Brand', 'ล.', '', '', 1),
(73, 'FFOR-K0001', 'Organic FairTrade Tamari soy sauce 1000 L', 'ล.', '', '', 1),
(74, 'FFOR-K0002', 'Organic Fairtrade Shoyu Soy sauce 1000 L -Autour Du Riz Brand', 'ล.', '', '', 1),
(75, 'FFOR-K0003', 'Organic Fairtrade Tamari Soy sauce No.1 1000L - Autur La Du Riz Brand', 'ล.', '', '', 1),
...
(99, 'FJEX-K0002', 'JOHIN EXTRA 1,000 L (For Thai Nikken Foods)', 'ล.', '', '', 1),
...
(113, 'FJGL-K0001', 'Johin Gluten Free Soy Sauce 1,000 Liters (Multipol)', 'ล.', '', '', 1),
(114, 'FJGL-K0002', 'Johin gluten free soy sauce 1,000 Liters (Thai Nikken)', 'ล.', '', '', 1),
...
(131, 'FJLI-A2001', 'Johin Light color soy sauce for KPT 200L drum', 'กก.', '', '', 1),
...
(201, 'FJTA-K0001', 'Johin Tamari Soy Sauce (Gluten free) For Thai Nichi 1000 L', 'ล.', '', '', 1),
...
(210, 'FOBY-K0001', 'น้ำมันถั่วเหลืองดิบ', 'กก.', '', '', 1),
...
(250, 'FSTA-K0001', 'Johin tamari soy sauce for Thai Nichi 1000L', 'ล.', '', '', 1),
(251, 'FSTA-K0002', 'Johin Tamari Soy Sauce No.1 for Thai nichi 1000L(RL-LQ-018-1)', 'ล.', '', '', 1),
...
(300, 'FVOR-K0001', 'Organic Fairtrade Rice vinegar 5% 1,000 L -Autour La Du Riz Brand', 'ล.', '', '', 1),
...
(2, 'LS', NULL, NULL, '#A9A9A9'),
(3, 'TA-R', NULL, NULL, '#FECDA6'),
(4, 'LS-OR-FT', NULL, NULL, '#FF9130'),
(5, 'TA-OR', NULL, NULL, '#FF5B22'),
(6, 'TA-OR-FT', NULL, NULL, '#7743DB'),
(7, 'TA', NULL, NULL, '#706233'),
(8, 'TAMARI', NULL, NULL, '#4F6F52'),
(9, 'LS-R', NULL, NULL, '#F875AA'),
