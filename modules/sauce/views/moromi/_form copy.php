                            ...
                            <div class="item card">
                                <div class="card-header text-white bg-dark">
                                    ...
                                    <div class="float-right">
                                        <button type="button" class="add-item btn btn-primary"><i class="fa fa-plus"></i> <?= Yii::t('app', 'Additional') ?></button>
                                        <button type="button" class="remove-item btn btn-danger"><i class="fa fa-minus"></i> <?= Yii::t('app', 'Removed') ?></button>
                                    </div>
