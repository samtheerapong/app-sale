...
class ItStockController extends Controller
{
    ...
    /**
     * Lists all ItStock models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new ItStockSearch();
    ...
    /**
     * Displays a single ItStock model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Updates an existing ItStock model.
    ...
    /**
     * Deletes an existing ItStock model.
    ...
    /**
     * Finds the ItStock model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return ItStock the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ItStock::findOne(['id' => $id])) !== null) {
            return $model;
        }
